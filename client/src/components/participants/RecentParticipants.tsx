                ...
                {participants.map((participant) => (
                    ...
                    >
                        <div className="flex items-center space-x-3">
                            <div className="w-12 h-12 bg-pink-500/10  border border-rose-500/20 rounded-full flex items-center justify-center text-white font-bold text-lg">
                                <User className="w-6 h-6 text-rose-400" />
                            </div>
                            <div className="flex-1">
                              <h4 className="font-semibold text-gray-200 group-hover:text-white capitalize transition-colors">
                            ...
                            <div className="bg-gray-900 px-3 py-1 rounded-full border border-gray-800">
                                <span className="text-emerald-400 font-bold font-mono">${participant.giftValue}</span>
                            </div>
                        </div>
                    </div>
                ))}
